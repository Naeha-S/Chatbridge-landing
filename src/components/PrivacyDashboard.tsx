...
export const PrivacyDashboard: React.FC = () => {
  ...
  return (
    <div id="privacy-live-dashboard" className="bg-white rounded-2xl border border-[#E5E5EA] p-6 sm:p-8 shadow-xs space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-[#E5E5EA]">
        ...
        {/* Quick Summary Pill */}
        <div className="flex items-center gap-2 bg-[#F5F5F7] p-2.5 rounded-xl border border-[#E5E5EA] self-start sm:self-auto">
          <ShieldIcon className="w-5 h-5 text-[#1D1D1F]" />
          <div className="text-right">
            <div className="text-[11px] font-mono text-[#6E6E73]">Network Egress</div>
            <div className="text-xs font-semibold text-[#1D1D1F]">0 bytes (Blocked)</div>
          </div>
        </div>
      </div>
      ...
      {actionNotice && (
        <div className="p-3 bg-[#F5F5F7] border border-[#D1D1D6] rounded-xl text-xs font-mono text-[#1D1D1F] flex items-center justify-between gap-2 animate-in fade-in">
          <div className="flex items-center gap-2">
            <CheckIcon className="w-4 h-4 text-[#0071E3] shrink-0" />
            <span>{actionNotice}</span>
          </div>
          <button
            onClick={() => setActionNotice(null)}
            className="text-[#86868B] hover:text-[#1D1D1F] text-xs font-mono"
          >
            Dismiss
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="rounded-xl border border-[#E5E5EA] bg-[#FAFAFA] p-5 sm:p-6 space-y-5">
          <div className="flex items-center justify-between pb-3 border-b border-[#E5E5EA]">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg bg-white border border-[#E5E5EA] flex items-center justify-center text-[#1D1D1F] shadow-2xs">
                <LockIcon className="w-4 h-4" />
              </div>
              <div>
                <h4 className="text-sm font-semibold text-[#1D1D1F]">Local Encryption Keys</h4>
                <p className="text-[11px] font-mono text-[#6E6E73]">AES-256-GCM / WebCrypto API</p>
              </div>
            </div>
          ...
          <div className="space-y-3 text-xs">
            <div className="flex items-center justify-between py-1 border-b border-[#EBEBED]">
              <span className="text-[#6E6E73]">Cipher Algorithm</span>
              <span className="font-mono font-medium text-[#1D1D1F]">AES-256-GCM (Authenticated)</span>
            </div>

            <div className="flex items-center justify-between py-1 border-b border-[#EBEBED]">
              <span className="text-[#6E6E73]">Key Storage Boundary</span>
              <span className="font-mono font-medium text-[#1D1D1F]">chrome.storage.local (Isolated Origin)</span>
            </div>

            <div className="flex items-center justify-between py-1 border-b border-[#EBEBED]">
              <span className="text-[#6E6E73]">Entropy Source</span>
              <span className="font-mono font-medium text-[#1D1D1F]">Hardware CSPRNG (12-byte IVs)</span>
            </div>

            <div className="flex items-center justify-between py-1 border-b border-[#EBEBED]">
              <span className="text-[#6E6E73]">Key Fingerprint (SHA-256)</span>
              <button
                onClick={handleCopyFingerprint}
                className="font-mono text-[11px] text-[#0071E3] hover:underline inline-flex items-center gap-1"
            ...
            <div className="flex items-center justify-between py-1">
              <span className="text-[#6E6E73]">Integrity Self-Test</span>
          ...
          <div className="pt-2 flex flex-wrap items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-white border border-[#D1D1D6] hover:bg-[#F5F5F7] text-xs font-medium text-[#1D1D1F] transition-colors inline-flex items-center gap-1.5 shadow-2xs disabled:opacity-50"
            >
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-white border border-[#D1D1D6] hover:bg-[#F5F5F7] text-xs font-medium text-[#515154] transition-colors inline-flex items-center gap-1.5 shadow-2xs"
            >
        ...
        <div className="rounded-xl border border-[#E5E5EA] bg-[#FAFAFA] p-5 sm:p-6 space-y-5">
          <div className="flex items-center justify-between pb-3 border-b border-[#E5E5EA]">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h4 className="text-sm font-semibold text-[#1D1D1F]">Sandboxed Database</h4>
            ...
            <span className="text-[11px] font-mono text-[#515154] bg-white px-2 py-0.5 rounded border border-[#E5E5EA]">
          ...
          <div className="space-y-1.5">
            <div className="h-3 w-full bg-[#E5E5EA] rounded-full overflow-hidden flex">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            {categories.map((cat, idx) => (
              <div key={idx} className="p-2 bg-white rounded-lg border border-[#EBEBED] space-y-0.5">
                <div className="flex items-center gap-1.5">
                  <span className={`w-2 h-2 rounded-full ${cat.color}`}></span>
                  <span className="font-medium text-[#1D1D1F] truncate text-[11px]">{cat.label}</span>
                </div>
                <div className="font-mono text-[11px] text-[#6E6E73] pl-3.5">
          ...
          <div className="pt-2 flex flex-wrap items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-white border border-[#D1D1D6] hover:bg-[#F5F5F7] text-xs font-medium text-[#1D1D1F] transition-colors shadow-2xs"
            >
              + Ingest 5 Turns
            </button>
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-white border border-[#D1D1D6] hover:bg-[#F5F5F7] text-xs font-medium text-[#515154] transition-colors shadow-2xs disabled:opacity-50"
            >
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-white border border-[#D1D1D6] hover:bg-[#F5F5F7] text-xs font-medium text-[#515154] transition-colors shadow-2xs"
            >
              Purge Expired
            </button>
          </div>
      ...
      <div className="rounded-xl border border-[#E5E5EA] bg-[#F5F5F7] p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs text-[#515154]">
        <div className="flex items-center gap-2.5">
          <AlertIcon className="w-4 h-4 text-[#86868B] shrink-0" />
          <span>
